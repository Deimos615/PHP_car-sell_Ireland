(function ($) {
  ...
  $(document).ready(function () {
    //New Countdown Starts in Index page
    $(".bid_counter_index")
      .map(function () {
        let endDate = $(this).text();
    ...
    $('.pass-retype').on('click', function () {
      var x = document.getElementById("login-repass");
      if (x.type === "password") {
        x.type = "text";
      } else {
        x.type = "password";

                        ...
                        <div class="tab-pane fade show active" id="upcoming">
                            <div class="row mb-30-none justify-content-center">
                                <?php
                                    ...
                                    // Finding highest offer
                                    // $sql = "SELECT a.cname, a.esti_price, a.offer, a.expires, a.winning, x.id, x.main_img
                                    //         FROM offer a
                                    //         INNER JOIN (
                                    //                 SELECT MAX(c.offer) as offer
                                    //                 FROM offer c
                                    //                 GROUP BY c.cname
                                    //         ) b ON a.offer = b.offer
                                    //         LEFT JOIN stock x ON a.cname = x.name
                                    //         WHERE a.expires > CURRENT_TIMESTAMP AND a.uemail='". $uemail ."' ";

                                    // Finding offer that admin selected
                                    $sql = "SELECT a.cname, a.esti_price, a.offer, a.expires, a.winning, x.id, x.main_img, x.name
                                            FROM offer a, stock x
                                            WHERE a.uemail='". $uemail ."' and a.cid = x.id and a.winning = 'win' ";
